...
import { PlatformContainerComponent } from './platform-container/platform-container.component';

const routes: Routes = [
  { path: '', component: StudentRegistrationComponent },
  {path: 'platform', component: PlatformContainerComponent,
    children: [
      { path: '', component: Year2Component },
